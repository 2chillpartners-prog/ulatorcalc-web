    ...
    <section className="py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-white hover:bg-[#C8D6E5] text-[#0D1B2A] font-bold px-8 py-4 rounded-xl text-base transition-all shadow-xl hover:-translate-y-0.5"
        >
        ...
        <p className="text-[#8B9CB3] text-sm mt-5">
