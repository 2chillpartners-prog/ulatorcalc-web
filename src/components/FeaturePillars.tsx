const pillars = [
  ...
  },
  {
    ...
    title: "11 trade modes",
    description:
      "Construction, electrician, HVAC, mechanic, accountant, pilot, crane, chef, scientist, detective, or plain. The right formulas, ready when you are.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
